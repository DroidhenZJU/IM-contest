...
def main(data_file = "E:\\天池比赛\\IM-contest\\data\\after_pre_process_A.xlsx"):
    ...
    answer_file = "GBDT_answer_" + os.path.basename(data_file).split('.')[0] + ".csv"
...
if  __name__ == "__main__":
    data_file = "E:\\天池比赛\\IM-contest\\data\\tree_feature_selected_A_1000.xlsx"
    main(data_file)